...
def forward_selection():
    ...
    for j in range(1,total_feature+1):
        ...
        for f in all_feature:
            ...
            print("Feature set: ",current_feature_set," Accuracy= ",average)
        ...
        print("Max Feature Set: ",max_feature_set, "  Accuracy: ",max)
    ...
    for j in range(total_feature-2,-1,-1):
        ...
        for i in range(0,len(list(itertools.combinations(all_feature, len(all_feature)-1)))):
            ...
            for train, test in kf.split(X):
                ...
                #print("Sum=",sum)
            average = (sum/n_splits)
            print("Features ",next_set[i],"  Accuracy= ",average)

            if(average>max_acc):
                max_acc=average
                current_max_set=next_set[i]
        print("\n\nMax accuracy feature set: ",current_max_set," Accuracy: ",max_acc)
...
def original_search():
    ...
    for i in range(0,total_feature):
        ...
        for train, test in kf.split(X):
            ...
            #print("Sum=",sum)
        average = (sum/n_splits)
        print("Features ",current,"  Accuracy= ",average)
        ...
        if(average>=max):
            ...
            print("Warning Accuracy Decreased. May be Local minima!")
            
    print("\n\n\nFinal feature set: ", final," Accuracy: ",max)

    plt.figure(figsize=(10,10))
    #print(plot_yb)
    plt.plot(plot_yo,plot_xo, linewidth=4, color='red',label='Modified')
